...
class Main:
    def __init__(self):
        ...
        self.strategy_code = 'STG0000000003'
        ...
        self.KLINE_INTERVAL = self.client.KLINE_INTERVAL_1MINUTE # KLINE_INTERVAL_1MINUTE, KLINE_INTERVAL_1HOUR
    ...
    def start_trade(self):
        ...
        while True:
            ...
            while True:
                ...
                #Trade Logic Check
                response = self.brain.strategy_opbstrat(self)
